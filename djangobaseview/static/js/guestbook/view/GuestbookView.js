...
], function(declare, lang, array, domConstruct, on, query, ValidationTextBox, WidgetsInTemplateMixin, registry, Greeting, GuestbookStore, _ViewBaseMixin, template) {

	return declare("guestbook.view.Guestbook",[_ViewBaseMixin], {
		...
		getGreetings: function() {
			...
			this.guestbookStore.getGreetings(this.guestbookName).then(
		...
		addNewGreeting: function() {
			if (this.contentNewGreeting.validate() == true) {
				...
				this.guestbookStore.addGreeting(messageGreeting).then(
